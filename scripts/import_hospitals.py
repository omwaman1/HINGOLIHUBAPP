...
ADMIN_USER_ID = 1
DEFAULT_IMAGE = 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=640'  # Hospital image
...
def import_hospitals():
    with open('hingoli_hospitals.json', 'r', encoding='utf-8') as f:
    ...
    for hospital in hospitals:
        ...
        if not address:
            address = 'Hingoli'  # Default if missing
